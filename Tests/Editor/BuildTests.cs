...
using UnityEngine.AdaptivePerformance.Tests;
using Object = UnityEngine.Object;

#if UNITY_EDITOR_WIN || UNITY_EDITOR_OSX

namespace UnityEditor.AdaptivePerformance.Editor.Tests.BuildTests
{
#if UNITY_EDITOR_WIN
    ...
    class GraphicsAPICompatibilityTests
    {
        ...
        public void CheckGraphicsAPICompatibilityOnBuild()
        {
            try
            {
                AdaptivePerformanceGeneralBuildProcessor.VerifyGraphicsAPICompatibility(m_Manager, m_PlayerSettingsDeviceType);
            }
