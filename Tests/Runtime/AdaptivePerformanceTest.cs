...
namespace UnityEditor.AdaptivePerformance.Tests
{
    public class AdaptivePerformanceSimulation : ManagementTestSetup
    {
        ...
        public IEnumerator All_Scalers_Available()
        {
            ...
            var tempScalers = new List<AdaptivePerformanceScaler>();
            var indexedScalers = new List<AdaptivePerformanceScaler>();

            apIndexer.GetAppliedScalers(ref tempScalers);
            indexedScalers.AddRange(tempScalers);

            apIndexer.GetUnappliedScalers(ref tempScalers);
            indexedScalers.AddRange(tempScalers);

            apIndexer.GetDisabledScalers(ref tempScalers);
            indexedScalers.AddRange(tempScalers);
