...
namespace UnityEngine.AdaptivePerformance
{
    internal class AutoPerformanceLevelController
    {
        ...
        // workaround for Samsung GameSDK bug where level 0 should not be used. In AP2.0 it is in provider logic.
        Version m_Version = new Version(3, 2);
        int m_MinCPULevel = 0;
        ...
        {
            if (m_PerfControl.CpuLevel > m_MinCPULevel && timestamp - m_LastCpuLevelRaiseTimeStamp > CpuLevelBounceAvoidanceThreshold)
            {
